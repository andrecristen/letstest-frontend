...
import FormDialogBase, { FormDialogBaseRef, FormDialogBaseExtendsRef } from "../base/FormDialogBase";
...
const ProjectForm = React.forwardRef<FormDialogBaseExtendsRef, ProjectFormProps>((props, ref) => {
  ...
  const onSubmit: SubmitHandler<ProjectData> = async (data) => {
    ...
    try {
      ...
      notifyService.error("Erro ao processar solicitação, tente novamente");
    }
